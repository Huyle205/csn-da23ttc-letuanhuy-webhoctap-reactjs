...
const EditLesson = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await apiClient(`http://localhost:3000/api/teacher/lessons/${lessonId}`, {
                method: "PUT",
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Chỉnh sửa bài học</h2>
                <p className="text-gray-600 text-sm mt-1">Cập nhật nội dung bài học</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
                ...
                <div className="flex items-center gap-4 pt-4 border-t">
                    ...
                    >
                        ...
                        <span>{loading ? "Đang cập nhật..." : "Cập nhật bài học"}</span>
                    </button>
                    <Link
                        to={`/teacher/courses/${courseId}/lessons`}
